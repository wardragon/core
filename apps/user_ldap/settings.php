 ...
 *
 */
$params = array('ldap_host', 'ldap_port', 'ldap_dn', 'ldap_agent_password', 'ldap_base', 'ldap_base_users', 'ldap_base_groups', 'ldap_userlist_filter', 'ldap_login_filter', 'ldap_group_filter', 'ldap_display_name', 'ldap_group_display_name', 'ldap_tls', 'ldap_turn_off_cert_check', 'ldap_nocase', 'ldap_quota_def', 'ldap_quota_attr', 'ldap_email_attr', 'ldap_group_member_assoc_attribute', 'ldap_cache_ttl', 'home_folder_naming_rule', 'ldap_naming_attribute', 'ldap_agent_password', 'ldap_base', 'ldap_base_users', 'ldap_base_groups', 'ldap_usersearch_filter','min_lenght_search');
...
$tmpl->assign( 'ldap_naming_attribute', OCP\Config::getAppValue('user_ldap', 'ldap_naming_attribute', 'uid'));
$tmpl->assign( 'ldap_usersearch_filter', OCP\Config::getAppValue('user_ldap', 'ldap_usersearch_filter', 'uid'));
$tmpl->assign( 'min_lenght_search', OCP\Config::getAppValue('user_ldap', 'min_lenght_search', 0));
